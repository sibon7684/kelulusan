...
import { Search, GraduationCap, MapPin, Calendar, CheckCircle2, XCircle, AlertCircle, RefreshCcw } from 'lucide-react';
...
export default function App() {
  ...
  return (
    <div className="min-h-screen min-h-[100dvh] bg-[#080808] text-white/90 font-sans selection:bg-gold-500/30 overflow-x-hidden flex flex-col">
      ...
      <nav className="relative z-10 px-8 pt-8 pb-4 md:pt-14 md:pb-10 flex justify-between items-center max-w-7xl mx-auto border-b border-white/5">
        <div className="flex items-center gap-4">
          <div className="w-6 h-6 md:w-10 md:h-10 border border-gold-500/30 flex items-center justify-center rotate-45 group hover:border-gold-500 transition-colors duration-500">
            <GraduationCap className="text-gold-500 w-3 h-3 md:w-5 md:h-5 -rotate-45" />
          </div>
          <span className="font-serif italic font-bold text-base md:text-2xl tracking-tight gold-gradient-text">SMA Muh Pakem</span>
        </div>
        <div className="hidden sm:flex gap-10 text-[10px] tracking-[0.2em] font-bold text-white/40 uppercase">
          <a href="#" className="hover:text-gold-400 transition-colors">Portal</a>
          <a href="#" className="hover:text-gold-400 transition-colors">Informasi</a>
          <a href="#" className="hover:text-gold-400 transition-colors">Bantuan</a>
        </div>
      </nav>
          ...
          {searchResult === undefined ? (
            ...
            >
              <div className="mb-4 md:mb-16">
                ...
                >
                  Masukkan NISN untuk mengakses pengumuman resmi kelulusan SMA Muhammadiyah Pakem.
                </motion.p>
              </div>
                ...
                <div className="glass-card rounded-[3rem] overflow-hidden shadow-2xl relative">
                  ...
                  <div className="p-3 md:p-16">
                    <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4 md:gap-12 text-center lg:text-left">
                      ...
                      <div className="flex flex-col items-center justify-center w-full lg:w-auto lg:min-w-[320px]">
                        <motion.div
                          initial={{ scale: 0.9, opacity: 0 }}
                          animate={{ scale: 1, opacity: 1 }}
                          transition={{ type: "spring", delay: 0.4 }}
                          className={cn(
                            "w-full py-4 md:py-12 px-4 md:px-10 rounded-[1.2rem] md:rounded-[2rem] flex flex-col items-center justify-center text-center gap-2 md:gap-6 relative overflow-hidden",
                  ...
                  <div className="bg-white/5 border-t border-white/5 px-6 md:px-12 py-3 md:py-8 flex flex-col sm:flex-row items-center justify-between gap-3 md:gap-6">
                    <p className="text-[8px] md:text-[10px] text-white/20 tracking-widest uppercase text-center sm:text-left">
                      Dokumen ini diterbitkan oleh SMA MUH PAKEM.
                    </p>
                    <button 
                      onClick={resetSearch}
      ...
      <footer className="relative z-10 py-4 md:py-10 border-t border-white/5 text-center px-6">
        ...
        <p className="text-white/10 text-[7px] md:text-[9px] tracking-[0.4em] font-medium uppercase leading-relaxed">
          &copy; 2026 &bull; SMA MUH PAKEM <br className="md:hidden" />
